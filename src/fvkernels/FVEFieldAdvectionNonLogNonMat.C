...
#include "FVEFieldAdvectionNonLogNonMat.h"

registerADMooseObject("rotomApp", FVEFieldAdvectionNonLogNonMat);

InputParameters
FVEFieldAdvectionNonLogNonMat::validParams()
{
...
FVEFieldAdvectionNonLogNonMat::FVEFieldAdvectionNonLogNonMat(const InputParameters & params)
  : FVFluxKernel(params),
...
ADReal
FVEFieldAdvectionNonLogNonMat::computeQpResidual()
{
  ADReal u_interface;
